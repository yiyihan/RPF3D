...
class DataProcessor(object):
    def __init__(self, processor_configs, point_cloud_range, training, num_point_features):
        ...
        self.grid_size = self.voxel_size = None
        self.data_processor_queue = []
        self.laser = LaserScan(project=True) # kitti
        # waymo
        # self.laser = LaserScan(project=True, H=64, W=2650, fov_up=2.4, fov_down=-17.6)
    ...
    def transform_points_to_voxels(self, data_dict=None, config=None):
        ...
        # print(points.size, np.asarray(points).shape)
        ...
        # print('out_dict_range,', out_dict['range'].shape, out_dict['range'].dtype)
        # print('out_dict_ori_xyz,', out_dict['ori_xyz'].shape, out_dict['range'].dtype)
        # print('out_dict_ori_r,', out_dict['ori_r'].shape, out_dict['range'].dtype)
        # print('out_dict_y,', out_dict['y'].shape, out_dict['range'].dtype)
